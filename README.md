...
NotebookRAG is a full-stack, secure RAG (Retrieval-Augmented Generation) application inspired by NotebookLLM. It allows you to upload documents and have grounded conversations with them using a robust Express backend and an AI-powered vector search engine.
